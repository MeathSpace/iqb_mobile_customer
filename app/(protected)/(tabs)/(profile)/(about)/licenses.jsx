...
const Licenses = () => {
  ...
  const content = i18n.t("protected.about.licenses.content", {
    returnObjects: true,
  });
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <CustomText style={styles.title}>
            {i18n.t("protected.about.licenses.header")}
          </CustomText>
        </View>
        ...
        >
          ...
          <CustomText style={styles.paragraph}>
            <CustomText style={styles.bold}>
              {content.effectiveDate_label}
            </CustomText>{" "}
            {content.effectiveDate_value}
          </CustomText>

          <CustomText style={styles.paragraph}>
            <CustomText style={styles.bold}>{content.appName_label}</CustomText>{" "}
            {content.appName_value}
          </CustomText>
          ...
          <CustomText style={styles.paragraph}>
            ...
            <CustomText style={styles.italic}>
              {content.intro1_highlight}
            </CustomText>
            {content.intro1_after}
            <CustomText style={styles.italic}>
              {content.intro1_app_highlight}
            </CustomText>
            {content.intro1_end}
          </CustomText>

          <CustomText style={styles.paragraph}>{content.intro2}</CustomText>

          {/* 1. License Grant */}
          <CustomText style={styles.subHeading}>
            {content.sections.licenseGrant.title}
          </CustomText>

          {content.sections.licenseGrant.allowPoints.map((item, index) => (
          ...
          <CustomText style={styles.paragraph}>
            {content.sections.licenseGrant.restrictionText}
          </CustomText>

          {content.sections.licenseGrant.restrictPoints.map((item, index) => (
            <CustomText key={index} style={styles.bullet}>
              • {item}
            </CustomText>
          ))}
          ...
          {/* 2. Ownership */}
          <CustomText style={styles.subHeading}>
            {content.sections.ownership.title}
          </CustomText>

          <CustomText style={styles.paragraph}>
            {content.sections.ownership.description_before}
            <CustomText style={styles.italic}>
              {content.sections.ownership.highlight}
            </CustomText>
            {content.sections.ownership.description_after}
          </CustomText>
          ...
          <CustomText style={styles.paragraph}>
            {content.sections.updates.description1}
          </CustomText>

          <CustomText style={styles.paragraph}>
            {content.sections.updates.description2}
          </CustomText>
          ...
          <CustomText style={styles.paragraph}>
            {content.sections.termination.description}
          </CustomText>

          {content.sections.termination.points.map((item, index) => (
            <CustomText key={index} style={styles.bullet}>
              • {item}
            </CustomText>
          ))}
          ...
          <CustomText style={styles.paragraph}>
            {content.sections.termination.footer}
          </CustomText>
          ...
          <CustomText style={styles.paragraph}>
            {content.sections.warranty.description1_before}
            <CustomText style={styles.italic}>
              {content.sections.warranty.description1_highlight}
            </CustomText>
            {content.sections.warranty.description1_after}
          </CustomText>

          <CustomText style={styles.paragraph}>
            {content.sections.warranty.description2}
          </CustomText>
          ...
          {content.sections.liability.points.map((item, index) => (
            <CustomText key={index} style={styles.bullet}>
              • {item}
            </CustomText>
          ))}
          ...
          <CustomText style={styles.paragraph}>
            {content.sections.liability.footer}
          </CustomText>
        </View>
      </ScrollView>
    </View>
