...
const GroupJoinBarber = () => {
    ...
    const { setSelectedMemberBarber, selectedMemberBarber, selectedMemberServices, setGroupJoinMembers, memberName, setMemberName, setSelectedMemberServices } = useGlobal()
                            ...
                            return (
                                <Pressable
                                    ...
                                    style={[styles.barberCard, {
                                        ...
                                        borderColor: selectedMemberBarber?.barberId === item?.barberId ? '#14b8a6' : colors.queueBorder,
                                        borderWidth: selectedMemberBarber?.barberId === item?.barberId ? scale(2) : scale(1),
                                    }]}
                                >
                                    <Image
