...
export const CalenderLeftIcon = ({
  size = moderateScale(24),
  color = "black",
  style,
}) => <AntDesign name="left" size={size} color={color} style={style} />;

export const CalenderRightIcon = ({
  size = moderateScale(24),
  color = "black",
  style,
}) => <AntDesign name="right" size={size} color={color} style={style} />;
...
export const CheckCircleIcon = ({
  ...
  <FontAwesome6 name="circle-check" size={size} color={color} style={style}  />
);
